...
export function Card({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div
      className={cn(
        'rounded-2xl border border-cream-200 bg-white shadow-[var(--shadow-soft)]',
        className,
      )}
      {...props}
    />
...
export function CardFooter({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return (
    <div
      className={cn('flex items-center gap-2 border-t border-cream-200 p-4 sm:p-5', className)}
      {...props}
    />
  )
}
